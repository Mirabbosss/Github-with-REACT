...
export const Profile = () => {
  ...
  return (
    <div className='profile'>
      ...
      <img src='https://avatars.githubusercontent.com/u/160228247?v=4' alt="profile avatar" />

      <h2>Mirabbos</h2>

      <p>Mirabbosss · he/him</p>

      <p>Frontend Developer</p>

      <a href="https://github.com/Mirabbosss" target='_blank'>
        <button className='hover:bg-[#34394249]'>Edit profile</button>
      </a>

      <div className="flex gap-2 items-center mb-[18px]">
        <Link to='https://github.com/Mirabbosss?tab=followers' target='_blank' className='links hover:text-blue-600'>
          <i className='bi bi-people'></i>
          <span>18 followers</span>
        </Link>

        <Link to='https://github.com/Mirabbosss?tab=following' target='_blank' className='links hover:text-blue-600'>
      ...
      <ul>
        ...
        <li>
          <i className='bi bi-geo-alt'></i>
          <span className='hover:text-blue-600'>Uzbekistan, Tashkent</span>
        </li>
